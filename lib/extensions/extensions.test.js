...
describe('extensions', () => {
    ...
    const doesFileExitInMockFileSystem = (pathParts) => {
        return Object.prototype.hasOwnProperty.call(testScope.fileSystem, path.join(...pathParts))
    }
    ...
    const mockUninstallExtension = (packageName) => {
        const existingPackageJson = JSON.parse(readFileFromMockFileSystem(['package.json']))
        if (!Object.prototype.hasOwnProperty.call(existingPackageJson.dependencies, packageName)) {
